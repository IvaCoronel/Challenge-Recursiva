...
public class Main {
	...
	public static void imprimirCincoNombresRiver(List<String> nombres){
		System.out.println(" ");
		System.out.println("Los cinco nombres m�s comunes entre los socios de River son: ");
	...
	public static void imprimirEstadisticasEquipo(List<ArrayList<String>> equipos){
		System.out.println("Equipos ordenados de mayor a menor seg�n la cantidad de socios: ");
		...
		for(ArrayList<String> e: equipos){
			System.out.println(" � Equipo: " + e.get(0)+ ", Cantidad de Socios: " + e.get(1) + ", Promedio de edad entre los Socios: " + e.get(2) + ", Edad m�nima: " + e.get(3) + ", Edad m�xima: " + e.get(4));
			System.out.println("------------------------------------------------------------------------------------------------------------------------");
		 }
	}
	...
	public static void menu(){
		...
		System.out.println("3- Los cinco nombres m�s comunes entre los socios de River");
		System.out.println("4- Lista de socios Universitarios y casados");
		System.out.println("5- Lista ordenada por Equipos (seg�n cantidad de socios), promedio de edad, edad M�x y Min.");
		System.out.println("6- Salir");
		System.out.println("----------------------------------------------------------------------------------------------");
		System.out.println("Ingrese el n�mero de la opcion que desee: ");
	}
